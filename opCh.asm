; BEHOLD THE CODE THAT COULD SAVE US ALL (WAG IPAMIGAY TANGINA NIYO)
; (PANG GRUPO LANG NATIN TO PLZ) 
; putangina ang haba nito (120 lines), kaya wag kabisaduhin, ARALIN
; kung pro ka, wag na basahin comments
; kung nalilito ka sa comments ko naman, sorry bobo ako
; well sana maaral lol
; sabog ako magexplain, so gomenasai(non weeb: sorry) 
;
;						-Gilson 
;
;      p.s.: di ko to maalala/magagawa kundi kay BJ, lab u :* <3 
;				di ko tuloy nagawa thesis ko dito.... :/ 
.model small
.stack 200h
.data
